...
void LCD5110_GPIO_Init() {
	LCD5510_RST_DDR |= 1<<LCD5510_RST_DDR;
	LCD5510_CE_DDR |= 1<<LCD5510_CE_DDR;
	LCD5510_DC_DDR |= 1<<LCD5510_DC_DDR;
	LCD5510_DIN_DDR |= 1<<LCD5510_DIN_DDR;
	LCD5510_CLK_DDR |= 1<<LCD5510_CLK_DDR;	
}
